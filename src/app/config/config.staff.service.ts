...
export class ConfigStaffService {
  ...
  async _getRetrieveStaffWithoutRotaDetail() {

    return await this.http.get(this.configUrl + '/staff/retrieveStaffWithoutRotaDetail');
  }
  ...
  async _getStaffAvailability () {
    return await this.http.get(this.configUrl + '/staff/retrieveStaffAvailability');
  }
  ...
  async _updateClient(data: any) {
    ...
    return this.http.post(this.configUrl + '/user/updateUserDetails', body, { 'headers': headers })
  }
